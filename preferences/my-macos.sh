...
# main source: ~/.macos — https://mths.be/macos
...
tell application "Terminal"
	...
	do shell script "open '$HOME/prefs/" & themeName & ".terminal'"
...
open "${HOME}/prefs/Solarized Dark.itermcolors"
...
# cp -r prefs/pref.sublime-settings ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Preferences.sublime-settings 2> /dev/null
...
###############################################################################
# Spectacle.app https://github.com/eczarny/spectacle#keyboard-shortcuts      #
###############################################################################
